...
import (
	...
	"github.com/G4AL-Entertainment/g4al-chain/docs"
)

const (
	AccountAddressPrefix = "g4al"
	Name                 = "g4al-chain"
)
...
func New(
	...
	*/
	...
	app.G4alchainKeeper = *g4alchainmodulekeeper.NewKeeper(
		appCodec,
		keys[g4alchainmoduletypes.StoreKey],
		keys[g4alchainmoduletypes.MemStoreKey],
		app.GetSubspace(g4alchainmoduletypes.ModuleName),
	)
