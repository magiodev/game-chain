...
var (
	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"G4AL-Entertainment", "g4al-chain", "assetfactory", "params"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Class_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"G4AL-Entertainment", "g4al-chain", "assetfactory", "class", "symbol"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_ClassAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"G4AL-Entertainment", "g4al-chain", "assetfactory", "class"}, "", runtime.AssumeColonVerbOpt(true)))
)
